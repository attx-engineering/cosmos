...
spec = Gem::Specification.new do |s|
  s.name = 'openc3-cosmos-tool-simcontrol'
  s.summary = 'OpenC3 COSMOS Sim Control Tool'
  s.description = <<-EOF
    Sets a simulation input to a value by sending an address/value JSON pair
    over the simulation's own port.
  EOF
