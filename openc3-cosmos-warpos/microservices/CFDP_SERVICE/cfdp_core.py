...
class CfdpReceiver:
    ...
    # COMPLETE_SUBDIR -- that's the only directory anything outside this
    # class (e.g. the CFDP Uplink tool's Downloads tab) should read from.
    ...
    def _handle_eof(self, key: TransactionKey, pdu: ParsedPdu) -> CfdpTransaction:
        ...
        if condition_code != 0:
            ...
            self._move_to_failed(transaction)
    ...
    def _move_to_failed(self, transaction: "CfdpTransaction"):
